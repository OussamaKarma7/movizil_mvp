                        ...
                        <div class="col-lg-7">
                            <div class="auth-form">
                                ...
                                <div class="soft-panel">
                                    <form method="POST" action="{{ route('login.attempt') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="nom@entreprise.com" required>
                                            @error('email')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Saisissez votre mot de passe" required>
                                            @error('password')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <p class="mt-3 mb-0 text-center">
                                    Nouveau client ? <a class="fw-semibold" href="{{ route('register') }}">Creer un compte</a>
                                </p>
                            </div>
                        </div>
                    </div>
