...
<body>
    ...
    <?php if($companyName): ?>
    <p>La société <strong>« <?php echo e(Str::upper($companyName)); ?> »</strong> SARL AU a domicilié son adresse fiscale dans nos locaux situés à :<br>
    <?php else: ?>
    <p>Monsieur/Madame <strong><?php echo e($clientName); ?></strong> a domicilié son adresse fiscale dans nos locaux situés à :<br>
    <?php endif; ?>
    <strong>ANGLE RUE EL AARAR et BD LALLA ELYACOUT, IMM1, 3 ème ETAGE, APPT 8</strong> pour une période allant du<br>
    <strong><?php echo e($startDate); ?> au <?php echo e($endDate); ?></strong></p>
    ...
    <div class="text-right mb-4" style="margin-top: 40px; margin-right: 50px;">
        ...
        Le : <strong><?php echo e($contract->start_date ? $contract->start_date->format('d/m/Y') : now()->format('d/m/Y')); ?></strong><br>
    ...
    <?php if($companyName): ?>
    <p>La société <strong>« <?php echo e(Str::upper($companyName)); ?> »</strong> SARL AU représenté par :<br>
    <?php else: ?>
    <p>
    <?php endif; ?>
    <strong>Mr/Mme <?php echo e($clientName); ?></strong> de nationalité Marocaine , né le <?php echo e($contract->client->birth_date ? \Carbon\Carbon::parse($contract->client->birth_date)->format('d/m/Y') : '.......'); ?> , titulaire de CIN n° <strong><?php echo e($contract->client->cin); ?></strong> ,Téléphone N°: <?php echo e($contract->client->phone); ?>, adress Email:<?php echo e($contract->client->email); ?>, demeurant à <?php echo e($contract->client->address); ?></p>
    ...
    <p>La présente domiciliation commence à courir <strong>Du <?php echo e($startDate); ?> au <?php echo e($endDate); ?></strong> Elle sera résilié automatiquement sans préavis ou un écrit fait par UNIVERSAL INVEST STRATEGY<br>
    ...
    <div style="margin-top: 40px; display: table; width: 100%;">
        <div style="display: table-cell; width: 50%; text-align: left; padding-left: 20px;">
            <p class="font-bold">Mr. <?php echo e($clientName); ?></p>
        </div>
...
<?php /**PATH C:\Users\pc\Desktop\V.finale finale\saas-accounting\resources\views/pdf/contract.blade.php ENDPATH**/ ?>