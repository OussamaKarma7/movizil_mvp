        ...
        <div class="body">
            ...
            <div class="info-box">
                <table>
                    ...
                    <tr>
                        <td>Durée :</td>
                        <td><?php echo e($contract->duration); ?> mois</td>
                    </tr>
                    <tr>
                        <td>Prix :</td>
                        <td><?php echo e(number_format($contract->price, 2, ',', ' ')); ?> MAD</td>
                    </tr>
                </table>
            </div>
            <div class="message">
...
<?php /**PATH C:\Users\pc\Desktop\V.finale finale\saas-accounting\resources\views/emails/contract.blade.php ENDPATH**/ ?>