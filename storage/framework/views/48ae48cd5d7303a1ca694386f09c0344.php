...
<body>
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <!-- Topbar -->
            <div class="topbar">
                <h4 class="mb-0 text-dark fw-bold fs-5"><?php echo $__env->yieldContent('title', 'Tableau de bord'); ?></h4>
                <div class="user-profile d-flex align-items-center">
                    <span class="me-3 fw-medium text-secondary" style="font-size: 0.9rem;">
                        <?php echo e(auth()->user()->name ?? 'Utilisateur'); ?>

                        (<?php echo e(auth()->user()?->isAdmin() ? 'Admin' : 'Client'); ?>)
                    </span>
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name ?? 'User')); ?>&background=4f46e5&color=fff" alt="Utilisateur" class="rounded-circle" width="36" height="36">
...
<?php /**PATH C:\Users\dell\Downloads\ProjetFinaleSaas\saas-accounting\resources\views/layouts/app.blade.php ENDPATH**/ ?>