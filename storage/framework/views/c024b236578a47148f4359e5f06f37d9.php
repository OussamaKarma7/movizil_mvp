<?php $__env->startSection('title', 'Renouvellement du Contrat'); ?>
        ...
        <div class="col-xl-6 col-lg-8">
            <div class="card border-0 shadow-sm p-4">
                <div class="d-flex align-items-center mb-4">
                    <a href="<?php echo e(route('contracts.show', $contract->id)); ?>" class="btn btn-light btn-sm me-3">
                        <i class="fa-solid fa-arrow-left"></i>
                    </a>
                    <h4 class="mb-0 fw-bold text-dark">Renouvellement du Contrat #<?php echo e($contract->id); ?></h4>
                </div>
                ...
                <form action="<?php echo e(route('contracts.storeRenewal', $contract->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="start_date" id="renewalStartDate"
                                   value="<?php echo e($contract->end_date ? $contract->end_date->copy()->addDay()->format('Y-m-d') : now()->format('Y-m-d')); ?>" required onchange="calculateRenewalPrice()">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Date de fin</label>
                            <input type="date" class="form-control" name="end_date" id="renewalEndDate"
                                   value="<?php echo e($contract->end_date ? $contract->end_date->copy()->addYear()->format('Y-m-d') : now()->addYear()->format('Y-m-d')); ?>" required onchange="calculateRenewalPrice()">
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pc\Desktop\saas-accounting\resources\views/pages/contracts/renew.blade.php ENDPATH**/ ?>