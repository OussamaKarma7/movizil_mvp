                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <form action="<?php echo e(route('clients.destroy', $client->id)); ?>" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce client et toutes ses données associées (contrats, factures, etc.) ?');">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pc\Desktop\V.finale finale\saas-accounting\resources\views/pages/clients/index.blade.php ENDPATH**/ ?>