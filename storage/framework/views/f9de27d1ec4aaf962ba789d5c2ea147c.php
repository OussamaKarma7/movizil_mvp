...
<body>
    ...
    <p>La société <strong>«<?php echo e($contract->client->company->company_name); ?>»</strong> (ICE: <?php echo e($contract->client->company->ice); ?>, RC: <?php echo e($contract->client->company->rc); ?>, IF: <?php echo e($contract->client->company->if); ?>) a domicilié son adresse fiscale dans nos locaux situés à :</p>
    <?php else: ?>
    <p>Monsieur/Madame <strong><?php echo e($contract->client->last_name); ?> <?php echo e($contract->client->first_name); ?></strong> a domicilié son adresse fiscale dans nos locaux situés à :</p>
    <?php endif; ?>

    <p class="font-bold">ANGLE RUE EL AARAR et BD LALLA ELYACOUT, IMM1, 3ème ETAGE, APPT 8</p>
    
    <p>pour une période allant du <strong><?php echo e($contract->start_date ? $contract->start_date->format('d/m/Y') : ''); ?></strong> au <strong><?php echo e($contract->end_date ? $contract->end_date->format('d/m/Y') : 'inconnue'); ?></strong>.</p>
    ...
    <div class="text-right mb-4">
        <p>Fait à Casablanca Le : <strong><?php echo e(now()->format('d/m/Y')); ?></strong></p>
    ...
    <?php if($contract->client->company && $contract->client->company->company_name): ?>
    <p>La société <strong>« <?php echo e($contract->client->company->company_name); ?> »</strong> SARL AU (ICE: <?php echo e($contract->client->company->ice); ?>, RC: <?php echo e($contract->client->company->rc); ?>, IF: <?php echo e($contract->client->company->if); ?>) représentée par :<br>
    <?php else: ?>
    <p>
    <?php endif; ?>
    Mr/Mme <strong><?php echo e(Str::upper($contract->client->last_name)); ?> <?php echo e(Str::upper($contract->client->first_name)); ?></strong> de nationalité Marocaine, titulaire de CIN n°<?php echo e($contract->client->cin); ?>, Téléphone N°: <?php echo e($contract->client->phone); ?>, adresse Email: <?php echo e($contract->client->email); ?>, demeurant à <?php echo e($contract->client->address); ?>.</p>
    ...
    <p>La présente domiciliation commence à courir Du <strong><?php echo e($contract->start_date ? $contract->start_date->format('d/m/Y') : ''); ?></strong> au <strong><?php echo e($contract->end_date ? $contract->end_date->format('d/m/Y') : ''); ?></strong>.<br>
    ...
    <div style="margin-top: 40px; display: table; width: 100%;">
        <div style="display: table-cell; width: 50%; text-align: center;">
            <p class="font-bold">Mr/Mme. <?php echo e(Str::upper($contract->client->last_name)); ?> <?php echo e(Str::upper($contract->client->first_name)); ?></p>
        </div>
        <div style="display: table-cell; width: 50%; text-align: center;">
...
<?php /**PATH C:\Users\pc\Desktop\saas-accounting\resources\views/pdf/contract.blade.php ENDPATH**/ ?>