...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control company-field <?php $__errorArgs = ['rce'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="rce" value="<?php echo e(old('rce', $company->rce ?? '')); ?>">
                        <?php $__errorArgs = ['rce'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['legal_form'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="legal_form" value="<?php echo e(old('legal_form', $company->legal_form ?? '')); ?>">
                        <?php $__errorArgs = ['legal_form'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="contract_type" required>
                            ...
                            <option value="Domiciliation" <?php echo e(old('contract_type') === 'Domiciliation' ? 'selected' : ''); ?>>Domiciliation Juridique</option>
                            <option value="Basic Accounting" <?php echo e(old('contract_type') === 'Basic Accounting' ? 'selected' : ''); ?>>Tenue de Comptabilite</option>
                            <option value="Consulting" <?php echo e(old('contract_type') === 'Consulting' ? 'selected' : ''); ?>>Conseil Juridique</option>
                        </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pc\Desktop\saas-accounting\resources\views/pages/client/contract_request.blade.php ENDPATH**/ ?>